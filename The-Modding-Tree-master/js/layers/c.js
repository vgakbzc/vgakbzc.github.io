addLayer("c", {
    ...
    upgrades : {
        ...
        21 : {
            ...
            description : "Less np are required to gain cp.",
            cost() {
        ...
        32 : {
            ...
            description : "Much less np are required to gain cp.",
            cost() {
        ...
        33 : {
            ...
            description : "Multiply effect of upgrade 11 by 1e5.",
            cost() {
        ...
        34 : {
            name : "Limit Break",
            description : "Break the softcap of 1e33 cp.",
            cost() {
