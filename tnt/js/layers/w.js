addLayer("w", {
    ...
    automate() {
        if((hasUpgrade("inf", 24) || hasUpgrade("et", 21)) && player["au"].autoRow2[3] && canReset(this.layer)) doReset(this.layer)
    ...
    milestonePopups() {
        return !((hasUpgrade("inf", 24) || hasUpgrade("et", 21)) && player["au"].autoRow2[3])
    }
})
